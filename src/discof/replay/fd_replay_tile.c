...
replay_block_start( fd_replay_tile_t *  ctx,
  ...
  FD_TEST( !fd_runtime_block_execute_prepare( ctx->banks, bank, ctx->accdb, &ctx->runtime_stack, ctx->capture_ctx, &is_epoch_boundary ) );
...
prepare_leader_bank( fd_replay_tile_t *  ctx,
  ...
  int is_epoch_boundary = 0;
  FD_TEST( !fd_runtime_block_execute_prepare( ctx->banks, ctx->leader_bank, ctx->accdb, &ctx->runtime_stack, ctx->capture_ctx, &is_epoch_boundary ) );
